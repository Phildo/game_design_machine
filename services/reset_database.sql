...
INSERT INTO machine_options (m_id, c_id, o_id) VALUES (1, 2, 4); /* ID- 4 */
INSERT INTO machine_options (m_id, c_id, o_id) VALUES (1, 2, 5); /* ID- 5 */
INSERT INTO machine_options (m_id, c_id, o_id) VALUES (1, 2, 6); /* ID- 6 */
INSERT INTO machine_options (m_id, c_id, o_id) VALUES (1, 3, 7); /* ID- 7 */
INSERT INTO machine_options (m_id, c_id, o_id) VALUES (1, 3, 8); /* ID- 8 */
INSERT INTO machine_options (m_id, c_id, o_id) VALUES (1, 3, 9); /* ID- 9 */
...
INSERT INTO icons (link_type, link_id, icon) VALUES ('OPTION', 9, 'what_war_opt.png'); /* I2- 14 */
